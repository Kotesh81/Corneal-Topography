...
public class InternalActivity extends Activity implements SurfaceHolder.Callback {
    SQLiteDatabase db;
    TextView testView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            public void onClick(View arg0) {
                Intent it=new Intent(InternalActivity.this,SuccessActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.internal, menu);
        return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home) {
            Intent it=new Intent(InternalActivity.this,FirstActivity.class);
            stop_camera();
            startActivity(it);
            finish();
            return true;
        ...
        if (id == R.id.action_external) {
            Intent it=new Intent(InternalActivity.this,MainActivity.class);
//            stop_camera();
            startActivity(it);
            finish();
            return true;
